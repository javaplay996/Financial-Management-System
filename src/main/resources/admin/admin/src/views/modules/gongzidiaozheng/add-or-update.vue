<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调整原因" prop="diaozhengyuanyin">
          <el-input v-model="ruleForm.diaozhengyuanyin" 
              placeholder="调整原因" clearable  :readonly="ro.diaozhengyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调整原因" prop="diaozhengyuanyin">
              <el-input v-model="ruleForm.diaozhengyuanyin" 
                placeholder="调整原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调整额度" prop="diaozhengedu">
          <el-input v-model="ruleForm.diaozhengedu" 
              placeholder="调整额度" clearable  :readonly="ro.diaozhengedu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调整额度" prop="diaozhengedu">
              <el-input v-model="ruleForm.diaozhengedu" 
                placeholder="调整额度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="调整时间" prop="diaozhengshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.diaozhengshijian" 
                type="date"
                :readonly="ro.diaozhengshijian"
                placeholder="调整时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.diaozhengshijian" label="调整时间" prop="diaozhengshijian">
              <el-input v-model="ruleForm.diaozhengshijian" 
                placeholder="调整时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	diaozhengyuanyin : false,
	diaozhengedu : false,
	diaozhengshijian : false,
  ...
  created() {
	this.ruleForm.diaozhengshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='diaozhengyuanyin'){
            this.ruleForm.diaozhengyuanyin = obj[o];
	    this.ro.diaozhengyuanyin = true;
            continue;
          }
          if(o=='diaozhengedu'){
            this.ruleForm.diaozhengedu = obj[o];
	    this.ro.diaozhengedu = true;
            continue;
          }
          if(o=='diaozhengshijian'){
            this.ruleForm.diaozhengshijian = obj[o];
	    this.ro.diaozhengshijian = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongzidiaozheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongzidiaozhengCrossAddOrUpdateFlag = false;
						 this.parent.search();
