<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="资产类别" prop="zichanleibie">
          <el-select :disabled="ro.zichanleibie" v-model="ruleForm.zichanleibie" placeholder="请选择资产类别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="资产类别" prop="zichanleibie">
	      <el-input v-model="ruleForm.zichanleibie"
                placeholder="资产类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资产状态" prop="zichanzhuangtai">
          <el-input v-model="ruleForm.zichanzhuangtai" 
              placeholder="资产状态" clearable  :readonly="ro.zichanzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资产价值" prop="zichanjiazhi">
          <el-input v-model="ruleForm.zichanjiazhi" 
              placeholder="资产价值" clearable  :readonly="ro.zichanjiazhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资产价值" prop="zichanjiazhi">
              <el-input v-model="ruleForm.zichanjiazhi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="风险计提" prop="fengxianjiti">
          <el-input v-model="ruleForm.fengxianjiti" 
              placeholder="风险计提" clearable  :readonly="ro.fengxianjiti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="风险计提" prop="fengxianjiti">
              <el-input v-model="ruleForm.fengxianjiti" 
                placeholder="风险计提" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="计提原因" prop="jitiyuanyin">
          <el-input v-model="ruleForm.jitiyuanyin" 
              placeholder="计提原因" clearable  :readonly="ro.jitiyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="计提原因" prop="jitiyuanyin">
              <el-input v-model="ruleForm.jitiyuanyin" 
                placeholder="计提原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='zichanleibie'){
            this.ruleForm.zichanleibie = obj[o];
	    this.ro.zichanleibie = true;
            continue;
          }
	    ...
	    this.ro.zichanjiazhi = true;
            continue;
          }
          if(o=='fengxianjiti'){
            this.ruleForm.fengxianjiti = obj[o];
	    this.ro.fengxianjiti = true;
            continue;
          }
          if(o=='jitiyuanyin'){
            this.ruleForm.jitiyuanyin = obj[o];
	    this.ro.jitiyuanyin = true;
            continue;
          }
          if(o=='dengjishijian'){
