<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="凭证单号" prop="pingzhengdanhao">
            <el-input v-model="ruleForm.pingzhengdanhao" 
                placeholder="凭证单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pingzhengdanhao" label="凭证单号" prop="pingzhengdanhao">
              <el-input v-model="ruleForm.pingzhengdanhao" 
                placeholder="凭证单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="收支类型" prop="shouzhileixing">
          <el-select :disabled="ro.shouzhileixing" v-model="ruleForm.shouzhileixing" placeholder="请选择收支类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="收支类型" prop="shouzhileixing">
	      <el-input v-model="ruleForm.shouzhileixing"
                placeholder="收支类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摘要" prop="zhaiyao">
          <el-input v-model="ruleForm.zhaiyao" 
              placeholder="摘要" clearable  :readonly="ro.zhaiyao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摘要" prop="zhaiyao">
              <el-input v-model="ruleForm.zhaiyao" 
                placeholder="摘要" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="对方科目" prop="duifangkemu">
          <el-input v-model="ruleForm.duifangkemu" 
              placeholder="对方科目" clearable  :readonly="ro.duifangkemu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="对方科目" prop="duifangkemu">
              <el-input v-model="ruleForm.duifangkemu" 
                placeholder="对方科目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	pingzhengdanhao : false,
	fapiao : false,
	shouzhileixing : false,
	zhaiyao : false,
	duifangkemu : false,
	jine : false,
	dengjishijian : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='pingzhengdanhao'){
            this.ruleForm.pingzhengdanhao = obj[o];
	    this.ro.pingzhengdanhao = true;
            continue;
          }
          if(o=='fapiao'){
	    ...
	    this.ro.fapiao = true;
          ...
          if(o=='shouzhileixing'){
            this.ruleForm.shouzhileixing = obj[o];
	    this.ro.shouzhileixing = true;
            continue;
          }
          if(o=='zhaiyao'){
	    ...
	    this.ro.zhaiyao = true;
          ...
          if(o=='duifangkemu'){
            this.ruleForm.duifangkemu = obj[o];
	    this.ro.duifangkemu = true;
            continue;
          }
          if(o=='jine'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xushizhang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xushizhangCrossAddOrUpdateFlag = false;
						 this.parent.search();
